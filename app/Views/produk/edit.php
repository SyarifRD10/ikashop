            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <input type="text" value="<?= $produk['nama_produk'] ?>" name="nama_produk" id="nama_produk" class="form-control" required>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <input type="number" value="<?= $produk['harga'] ?>" name="harga" id="harga" class="form-control" step="0.01" required>
                    </td>
                </tr>
                <tr>
                    <td>
